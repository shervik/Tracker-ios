...
//  Tracker
//
//  Created by Виктория Щербакова on 02.10.2023.
//
...
final class TrackerEditViewController: UIViewController {    
    ...
    override func viewDidLoad() {
        ...
        trackerSetupCollection.add(items: ["Категория", "Расписание"])
        hideKeyboard()
    }
...
extension TrackerEditViewController: CollectionViewDelegate {

    func didEnabledCreateButton(isEnabledCreate: Bool, isEmptyWeekDay: Bool) {
        let isNotEmptySchedule = !isEmptyWeekDay
